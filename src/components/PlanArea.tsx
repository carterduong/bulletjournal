    ...
    <div className="grid size-full grid-cols-6 grid-rows-[66%_1fr_auto] gap-2">
      ...
      {contextMenu && (
        <>
          ...
          <div
            role="menu"
            className="fixed z-50 min-w-52 rounded-lg border border-menu-border bg-(--color-menu-bg) p-1 shadow-lg"
          ...
          >
            <button
              ...
              role="menuitem"
              autoFocus
              className="w-full cursor-pointer rounded-lg px-3 py-2 text-left leading-normal text-menu-text hover:bg-menu-hover focus:bg-menu-hover focus:outline-none"
              onClick={() => {
